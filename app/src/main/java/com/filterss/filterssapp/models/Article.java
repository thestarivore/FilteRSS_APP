...
public class Article implements Serializable {
    ...
    // local field to know if the article was read. The info is store in the local db
    ...
    public void setPubDateFromString(String pubDateStr){
        SimpleDateFormat sdfFromSQLiteDB = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH);
        try{
    ...
    // used by the local storage to sort the articles by date
    public void setPubDateAsString(String dateString) {
        this.pubDateAsString = dateString;
    }
