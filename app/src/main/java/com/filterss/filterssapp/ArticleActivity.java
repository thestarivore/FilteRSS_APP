...
import com.filterss.filterssapp.controllers.OnSwipeTouchListener;
...
public class ArticleActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteService.setArticleRead(article.getHashId(), new SQLOperationCallback() {
            @Override
            ...
            public void onFailure() {
                Log.d(ArticleActivity.logTag + ":" + TAG, "Article read NOT saved locally");
            }
        });
    }
